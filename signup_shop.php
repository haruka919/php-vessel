    ...
    if(empty($err_msg)){
      ...
      if(empty($err_msg)){
        ...
        try {
          ...
          $dbh = dbConnect();
          // SQL文作成
          $sql = 'INSERT INTO author (email, password, login_time, create_date) VALUES (:email, :pass, :login_time, :create_date)';
          ...
          if($stmt){
            ...
            $_SESSION['author_id'] = $dbh->lastInsertId();
